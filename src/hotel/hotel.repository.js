...
async function insertHotel (hotel) {
  const newHotel = await prisma.hotel.create({
    data: {
      ...
      harga_minimum: hotel.harga_minimum,
      harga_maximum:hotel.harga_maximum,
...
async function editHotel (id, hotel) {
  const updateHotel = await prisma.hotel.update({
    ...
    data: {
      ...
      ...(hotel.harga_minimum && { harga_minimum: hotel.harga_minimum }),
      ...(hotel.harga_maximum && { harga_maximum: hotel.harga_maximum }),
